...
const Reservations = () => {
  ...
  return (
    <div className="h-full w-full pt-16 pb-16  flex flex-col justify-center items-center overflow-y-hidden overflow-x-hidden">
      <DynamicTable
        headers={headers}
        data={transFormDate}
      ...
      <div className="flex justify-center space-x-3 h-12 items-center ">
        ...
        <div className="flex items-center space-x-3 ">
          <h3> {finalpage !== pagination ? finalpage : ""}</h3>
          <img
            onClick={() => {
